...
const ListTransactionToWarehouse = () => {
  ...
  return (
    <div className="manager">
      <h1 className="page_title">Đơn hàng gửi tới điểm tập kết</h1>
      <DashBoard>
      ...
      <div className="pagination" id="pagination">
        {[
          ...Array(
            Math.ceil(listInWarehouseTransactionToWarehouse.length / ((0.73 * height) / 60))
          ).keys(),
        ].map((i) => (
          <div
            id={"page_" + i}
...
export default ListTransactionToWarehouse;
